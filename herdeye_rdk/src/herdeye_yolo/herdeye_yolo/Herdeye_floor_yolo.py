...
class YOLOv10Node(Node):
    def __init__(self):
        ...
        self.declare_parameters(
            namespace='',
            parameters=[
                ('model_path', '/home/root/yolov10n_bayes-e_640x640_nv12_modified.bin'),
                ('camera_id', 0),
                ('show_fps', False),
                ('iou_thres', 0.45),
                ('conf_thres', 0.25),
        ...
        self.detection_pub = self.create_publisher(Detection2DArray, 'floor_detections', 10)
        self.image_pub = self.create_publisher(Image, 'floor_detected_image', 10) if self.get_parameter('publish_image').value else None
