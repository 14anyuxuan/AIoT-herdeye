...
# 使用绝对路径进行拷贝操作
cp -rv "$ONESDK_ROOT_DIR/build/output/"* "$ONESDK_ROOT_DIR/examples/onesdk_esp32/"
cp -v "$ONESDK_ROOT_DIR/examples/onesdk_esp32/components_cmakelists.txt" "$ONESDK_ROOT_DIR/examples/onesdk_esp32/components/onesdk/CMakeLists.txt"
cp -v "$ONESDK_ROOT_DIR/examples/onesdk_esp32/libwebsockets_cmakelists.txt" "$ONESDK_ROOT_DIR/examples/onesdk_esp32/libwebsockets/CMakeLists.txt"