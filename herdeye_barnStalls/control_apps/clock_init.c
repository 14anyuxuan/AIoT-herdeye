...
void BOARD_InitBootClocks(void)
{
    ...
    /* DMA2. */
    RCC_EnableAHB1Periphs(RCC_AHB1_PERIPH_DMA2, true);
    RCC_ResetAHB1Periphs(RCC_AHB1_PERIPH_DMA2);
    ...
    RCC_ResetAPB1Periphs(RCC_APB1_PERIPH_TIM3);
	
	/* TIM8. */
    RCC_EnableAPB2Periphs(RCC_APB2_PERIPH_TIM8, true);
    RCC_ResetAPB2Periphs(RCC_APB2_PERIPH_TIM8);
}
